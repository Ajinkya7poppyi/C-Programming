// C Program To Concatenate Without Using string.h Library (Memory Allocation)
...
int main()
{
    ...
    char* input_string1=(char*) malloc(BUFFERSIZE * sizeof(char));
    char* input_string2=(char*) malloc(BUFFERSIZE * sizeof(char));
    char state_continue;

    while(true)
    {
        memset(input_string1, ZERO, sizeof(char)* BUFFERSIZE);
        memset(input_string2, ZERO, sizeof(char)* BUFFERSIZE);
        ...
        if(sizeof(input_string1) >= (strlen(input_string1)+strlen(input_string2)))
        {
            ...
            input_string1=(char*)realloc(input_string1, (strlen(input_string1) + strlen(input_string2)) * sizeof(char));
        }
